        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '80px' }}>
          ...
          >
            ...
            <div
              ...
              style={{ width: '100%', height: '250px', backgroundColor: '#E8E2D5', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}
            >
          ...
          >
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                ...
                >
                  {submitting ? 'Sending...' : <>Send Message <span className="send-btn-arrow">→</span></>}
                </button>
              </form>
            )}
          </motion.div>
